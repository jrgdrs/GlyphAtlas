...
(async () => {
  ...
  for (let i = 0; i < keys; i++) {
    ...
    if (glyph) {
     ...
     /*
        // Metrics
        var myWidth = font.getAdvanceWidth(letter, 1000)
        //console.error(myWidth)
        var myMetric = 'M0 1000 L1000 1000 Z M100 0 L100 1200 Z M' + (myWidth + 100) + ' 0 L ' + (myWidth + 100) + ' 1200 Z'
        var myMetricString = '<path class="pMetric" d="' + myMetric + '"/>\r\n'
*/
        //Glyph
        ...
        var myOut = ''
        var remember = []
        //console.log( JSON.stringify(myPath.commands));
        myPath.commands.forEach(myPoint => {
          //console.error( JSON.stringify(myPoint), "\r");
          switch (myPoint.type) {
            case 'Q':
              //myOut += myPoint.type + myPoint.x + "," + myPoint.y  + " ";
